...
int main()
{
	...
	int nums[] = { 10, 15, 30, 52, 40, 35, 38 , 39, 7, 9, 6 };
	int deletion_nums[] = {   30 };
	for (i = 0; i < 11; i++)
	{
		int x = nums[i];
		int y = i;
